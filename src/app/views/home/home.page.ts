...
import { AlertController, AnimationController, IonicModule, LoadingController, ModalController, NavController } from '@ionic/angular';
...
export class HomePage implements OnInit {
  ...
  async confirmLogOutAlertCtrl() {
    const alert = await this.alertCtrl.create({
      header: 'DECONNEXION',
      subHeader: 'Vous voulez nous quitter ?',
      buttons: [
        {
          text: 'Non',
          role: 'cancel',
